...
# =============================================================================
# the multiplication hyperparameter:
...
RatioHyper = 0.2# determines the ratio of rareterms/maxfeatures: i.e. 0.3 = 30% of the max features is the absolute rare term integer: eg 100 max features * 0.3 = rareterm = 30; this is because the ratio determines the enrichement %; now it is robust, if max feature changes, there is no problem
...
# LEMMA= 
MAXFEATURES = [5000,10000,15000,20000,25000]#,12000,28000,5000,10000,15000,25000,30000,35000]#,16000,21000,18000,19000,17000,25000,8000]#, 15000,20000,25000,30000,32324]# 4000, 5000, 6000]
MAX_DF_LIST = [1.0]
MIN_DF = 1
...
#!!! =============================================================================
                             for NEIGHBOR in model.similar_by_word(TERM, topn= TOP_NEIGHBORS: #SET 'K' NEIGHBORs HYPERPARAMATER
# =============================================================================
...
#                    from sklearn import svm
            ...
            def paraPickleSaverBASE(clf):
                ...
                with open(PATH+f'{TIME};_____Base_f1Macro={F1_score};_TnTp={TnTp};_CLF={CLF_name};__{VECTORIZER_TYPE};_max_features={MAX_FEATURES};_ngram_range={NGRAM_RANGE};_max_df={MAX_DF};_min_df={MIN_DF};__similarity={SIMILARITY_HYPERPARA};_rareterm={RARETERM};_ratioRareMax={Ratio_rareVSMaxFeature};_Seed={SEED}___.thesis', 'wb') as f:
