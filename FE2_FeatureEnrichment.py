...
WORD2VEC_GLOVE_FILE = get_tmpfile("glove.6B.100d.txt") # specify which d file is used here
...
# ***NOTE FROM THE DEVELOPER: From here on, A novice can run everything, information for understanding is provided in the print commands ***
