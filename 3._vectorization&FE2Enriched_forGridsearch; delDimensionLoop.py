...
#======================================================================== #
WORDVEC_TYPE = 'Glove'
WordvecModel = gloveModel #selfTrainedw2vModel_small , selfTrainedw2vModel_big

RatioHyper = 0.3# determines the ratio of rareterms/maxfeatures: i.e. 0.3 = 30% of the max features is the absolute rare term integer: eg 100 max features * 0.3 = rareterm = 30; this is because the ratio determines the enrichement %; now it is robust, if max feature changes, there is no problem
...
#               for I in range(1,10): # if you want to hyper tuning
                ...
                #for i,j in zip(y_test, ŷ_nb_enriched):    print(i==j)
                print('\n format of CM:\n', np.array([    ['TN', 'FP'],
                                                          ['FN', 'TP']]) )
                print('\n***', nb_classifier, '***\n\nENRICHED NB')
                #print(str( vectorizer)[:13])
